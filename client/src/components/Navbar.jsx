...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0">
      ...
      {userData ? (
        <div
          className="w-8 h-8 flex justify-center items-center rounded-full bg-black text-white relative cursor-pointer group
      "
        >
        ...
        text-black rounded pt-10"
          >
            <ul className="list-none m-0 p-2 bg-gray-200 text-sm">
              ...
              <li
                onClick={logout}
                className="py-1 px-2 hover:bg-gray-300 pr-10 cursor-pointer"
              >
                Logout
              </li>
            </ul>
      ...
      rounded-full px-6 py-2 text-black hover:bg-blue-600 hover:text-white 
      transition-all"
        >
